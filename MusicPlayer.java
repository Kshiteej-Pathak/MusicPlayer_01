...
class MPlayer implements ActionListener {
    ...
    public MPlayer() {
        ...
        addActionEvents();
        //Calling Threads: the direction or path that is taken while a program is being executed.
    ...
    public void initUI() {
        ...
        //Creating icons for buttons
        iconPlay = new ImageIcon("C:\\Users\\KSHITEEJ\\Downloads\\music-player-icons\\play-button.png");
        iconPause = new ImageIcon("C:\\Users\\KSHITEEJ\\Downloads\\music-player-icons\\pause-button.png");
        iconResume = new ImageIcon("C:\\Users\\KSHITEEJ\\Downloads\\music-player-icons\\resume-button.png");
        iconStop = new ImageIcon("C:\\Users\\KSHITEEJ\\Downloads\\music-player-icons\\stop-button.png");
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource().equals(select)) {
           fileChooser = new JFileChooser();
            fileChooser.setCurrentDirectory(new File("C:\\Users\\KSHITEEJ\\Downloads\\music-player-java-code\\song"));
